...
public class JwtService implements Serializable {
    ...
    private static final long JWT_TOKEN_VALIDITY = 5 * 60 * 60; // 5분

    // @Value("${jwt.secret}")
    private String secret = "mysns";
    ...
    public String generateToken(ClientDto client){
        ...
        return doGenerateToken(claims, client.getUsername()+'|'+client.getLastAccess());
    }
