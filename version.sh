...
sed -i 's/spring.redis.host = /#spring.redis.host/' ./mySns/mySns/src/main/resources/application.properties
echo spring.redis.host=172.17.0.1 >> ./mySns/mySns/src/main/resources/application.properties
